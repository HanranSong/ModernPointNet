...
class FeaturePyramidNetwork(nn.Module):
    ...
    """
    def __init__(self, feature_channels=[64, 128, 256, 512], feature_size=256):
...
class PointHead(nn.Module):
    ...
    """
    def __init__(self, in_channels, point_count=4, feature_size=256):
...
class ClassificationHead(nn.Module):
    ...
    Simplified and optimized compared to original implementation.
    """
    def __init__(self, in_channels, point_count=4, num_classes=2, feature_size=256):
